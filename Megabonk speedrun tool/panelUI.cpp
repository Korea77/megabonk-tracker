...
namespace PanelUI {
    ...
    void Render() {
        ...
        if (showMenu) {
            ...
            //        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.92f, 0.25f, 0.20f, 1));
            //    }
            //    else {
            //        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.66, 0.66, 0.66, 1));
            //    }
            ...
            if (currentSelected == 0) {
                ...
                magnetShrines = "Chargable shrines: " + std::to_string(Game->ChargableShrines.count());
                ImGui::TextColored(ImVec4(1.0f, 1.0f, 1.0f, 1.0f), magnetShrines.c_str());
                ...
                if (Game->bSeed) {
                ImGui::Checkbox("Lock seed", &Game->bSeedLocked);
                ...
                ImGui::Checkbox("Unlock everything", &Game->bUnlockEverything);
            }
            ImGui::End();
        }
        ImGuiIO& io = ImGui::GetIO();
